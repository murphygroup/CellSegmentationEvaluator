...
def single_method_eval(img, mask, PCA_model, output_dir: Path, bz=0, unit='nanometer', pixelsizex = 377.5, pixelsizey = 377.5):
...
def single_method_eval_3D(img, mask, PCA_model, output_dir: Path, unit='nm', pixelsizex=377.5, pixelsizey=377.5,
                          pixelsizez=377.5) -> Tuple[Dict[str, Any], float, float]:
    print("Calculating evaluation metrics v1.5 for", img['name'])
