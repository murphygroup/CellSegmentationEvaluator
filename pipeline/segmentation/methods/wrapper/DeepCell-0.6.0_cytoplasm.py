...
imsave(join(file_dir, 'mask_DeepCell-0.6.0_cytoplasm.png'), cell_mask)
np.save(join(file_dir, 'mask_DeepCell-0.6.0_cytoplasm.npy'), cell_mask)
imsave(join(file_dir, 'nuclear_mask_DeepCell-0.6.0_cytoplasm.png'), nuc_mask)
np.save(join(file_dir, 'nuclear_mask_DeepCell-0.6.0_cytoplasm.npy'), nuc_mask)
